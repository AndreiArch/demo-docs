...
<WorkflowBlock>
  <WorkflowBlockItem>
    ...
    <Image src="https://api.archbee.com/api/optimize/MM6nC_bKbIkwCRqiFZqEu/MIHupM9-aG5UQ57uwzZYM_image.png" size="50" width="373" height="864" caption="Go to Import/Export" position="center" showCaption="true"></Image>
  </WorkflowBlockItem>
  ...
  <WorkflowBlockItem>
    ...
    <Image src="https://api.archbee.com/api/optimize/MM6nC_bKbIkwCRqiFZqEu/0PsnXhOrn0KDJLsUCOnIx_image.png" size="80" width="850" height="449" caption="Import Data section. Click on the Download Template button to get a blank CSV" position="center" showCaption="true"></Image>
  ...
  <WorkflowBlockItem>
    ...
    <Image src="https://api.archbee.com/api/optimize/MM6nC_bKbIkwCRqiFZqEu/FIfztYwctm-BxjY-pFuc-_image.png" size="80" width="850" height="449" caption="Import Data section" position="center" showCaption="true"></Image>

    Select **Import logs** **→** **Execution logs** to confirm import completion.

    <Image src="https://api.archbee.com/api/optimize/MM6nC_bKbIkwCRqiFZqEu/plMbmKQh6CTM9ZNdOW2QZ_image.png" size="80" width="1536" height="953" caption="Execution Logs" position="center" showCaption="true"></Image>
  </WorkflowBlockItem>
...
<WorkflowBlock>
  <WorkflowBlockItem>
    ...
    <Image src="https://api.archbee.com/api/optimize/MM6nC_bKbIkwCRqiFZqEu/Ifk6eTGvcs5l7RfnGPeR4_image.png" size="60" width="746" height="1728" position="center" caption="Go to Import/Export" showCaption="true"></Image>
  </WorkflowBlockItem>
  ...
  <WorkflowBlockItem>
    ...
    <Image src="https://app.archbee.com/api/optimize/MM6nC_bKbIkwCRqiFZqEu/Mqx3APgsX67RNVB5iCr-K_image.png" size="80" width="1232" height="716" position="center" caption="Export Data section of the Import/Export page" showCaption="true"></Image>
...
<WorkflowBlock>
  ...
  <WorkflowBlockItem>
    ...
    <Image src="https://api.archbee.com/api/optimize/MM6nC_bKbIkwCRqiFZqEu/nqJp5H0x9J81pH1Ypi-jW_image.png" size="70" width="1842" height="306" caption="EBD Vendor Export CSV opened in Numbers. Note the ID column on the far left" position="center" showCaption="true"></Image>
  ...
  <WorkflowBlockItem>
    ...
    <Image src="https://api.archbee.com/api/optimize/MM6nC_bKbIkwCRqiFZqEu/jUXa0qjxDpjhujcAE4NP-_image.png" size="70" width="1194" height="710" caption="Import Data section. Click &#x22;Select a CSV file&#x22; or drag-and-drop a CSV file in this section to import your CSV file" position="center" showCaption="true"></Image>
...
<table isTableHeaderOn="true" columnWidths="358,358">
  <tr>
    <td align="left">
      **Issue**
    </td>
...
<table isTableHeaderOn="true" columnWidths="238,238,240">
  <tr>
    <td align="left">
      **Name**
    </td>
...
<WorkflowBlock>
  <WorkflowBlockItem>
    ...
    <Image src="https://api.archbee.com/api/optimize/MM6nC_bKbIkwCRqiFZqEu/hU7t7xkvUbOUebvgaxyOL_image.png" size="60" width="373" height="864" position="center" caption="Go to Import/Export" showCaption="true"></Image>
  </WorkflowBlockItem>
  ...
  <WorkflowBlockItem>
    ...
    <Image src="https://api.archbee.com/api/optimize/MM6nC_bKbIkwCRqiFZqEu/EHk3BvBSSxEDdcl7oxrdk_image.png" size="80" width="838" height="590" caption="Click to show Electronic Bank Payments export" position="center" showCaption="true"></Image>
    ...
    <Image src="https://api.archbee.com/api/optimize/MM6nC_bKbIkwCRqiFZqEu/SVKiGha6pcyxb2Zbbsoev_image.png" size="80" width="1098" height="640" caption="Generate CSV file" position="center" showCaption="true"></Image>
  ...
  <WorkflowBlockItem>
    ...
    **Select a CSV file…&#xA0;**&#x6F;r drag and drop the CSV file(s) into th&#x65;**&#x20;Import Data&#x20;**&#x62;ox.
    ...
    <Image src="https://api.archbee.com/api/optimize/MM6nC_bKbIkwCRqiFZqEu/8kHSpO7kQwE1ohrR6KjRj_image.png" size="80" width="850" height="449" caption="Import Data section" position="center" showCaption="true"></Image>
  ...
  <WorkflowBlockItem>
    ...
    <Image src="https://api.archbee.com/api/optimize/MM6nC_bKbIkwCRqiFZqEu/U4bk1YvcMd4AC84XLAgK6_image.png" size="82" width="632" height="358" caption="Confirm Status" position="center" showCaption="true"></Image>
