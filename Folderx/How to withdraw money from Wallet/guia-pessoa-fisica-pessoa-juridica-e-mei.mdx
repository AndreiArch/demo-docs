...
- :Link[O INSS]{label="O INSS" overridedLabel="O INSS" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#o-inss" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
- :Link[O IRRF]{label="O IRRF" overridedLabel="O IRRF" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#o-irrf" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
- :Link[NIS/PIS/PASEP]{label="NIS/PIS/PASEP" overridedLabel="NIS/PIS/PASEP" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#nis-pis-pasep" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
...
- :Link[Porque a Admitad solicita o meu número de NIS/PIS/PASEP?]{label="Porque a Admitad solicita o meu número de NIS/PIS/PASEP?" overridedLabel="Porque a Admitad solicita o meu número de NIS/PIS/PASEP?" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#porque-a-admitad-solicita-o-meu-numero-de-nis-pis-pasep" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
- :Link[Onde encontrar o número NIS/PIS/PASEP?]{label="Onde encontrar o número NIS/PIS/PASEP?" overridedLabel="Onde encontrar o número NIS/PIS/PASEP?" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#onde-encontrar-o-numeronis-pis-pasep" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
- :Link[É obrigatório fornecer o número do NIS/PIS/PASEP?]{label="É obrigatório fornecer o número do NIS/PIS/PASEP?" overridedLabel="É obrigatório fornecer o número do NIS/PIS/PASEP?" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#e-obrigatorio-fornecer-o-numero-do-nis-pis-pasep" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
...
- :Link[CNPJ]{label="CNPJ" overridedLabel="CNPJ" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#cnpj" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
- :Link[Microemprendedor Individual (MEI)]{label="Microemprendedor Individual (MEI)" overridedLabel="Microemprendedor Individual (MEI)" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#microemprendedor-individual" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
   

### Manual para recebimento como pessoa jurídica — [#](#)CNPJ

- :Link[Instruções para o envio do e-mail com a Nota Fiscal]{label="Instruções para o envio do e-mail com a Nota Fiscal" overridedLabel="Instruções para o envio do e-mail com a Nota Fiscal" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#instrucoes-para-o-envio-do-email-com-a-nota-fiscal" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
- :Link[Cadastro de empresas de fora do município]{label="Cadastro de empresas de fora do município" overridedLabel="Cadastro de empresas de fora do município" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#cadastro-de-empresas-de-fora-do-municipio" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
- :Link[Se cadastrou no CPOM e mesmo assim sofreu descontos?]{label="Se cadastrou no CPOM e mesmo assim sofreu descontos?" overridedLabel="Se cadastrou no CPOM e mesmo assim sofreu descontos?" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#se-cadastrou-no-cpom-e-mesmo-assim-sofreu-desconto" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
- :Link[É possível receber pagamentos de comissão da Admitad sem emitir Nota Fiscal?]{label="É possível receber pagamentos de comissão da Admitad sem emitir Nota Fiscal?" overridedLabel="É possível receber pagamentos de comissão da Admitad sem emitir Nota Fiscal?" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#e-possivel-receber-pagamentos-de-comissao-da-admitad-sem-emitir-nota-fiscal" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
- :Link[É preciso ter uma conta bancária jurídica para receber as comissões?]{label="É preciso ter uma conta bancária jurídica para receber as comissões?" overridedLabel="É preciso ter uma conta bancária jurídica para receber as comissões?" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#e-preciso-ter-uma-conta-bancaria-jur%C3%ADdica-para-receber-as-comissoes" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
   
...
- :Link[Recomendação Admitad: Quando é vantajoso ser um MEI?]{label="Recomendação Admitad: Quando é vantajoso ser um MEI?" overridedLabel="Recomendação Admitad: Quando é vantajoso ser um MEI?" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#quando-e-vantajoso-ser-um-mei" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
- :Link[Em que categoria devo me enquadrar/registrar para ser um afiliado MEI na Admitad?]{label="Em que categoria devo me enquadrar/registrar para ser um afiliado MEI na Admitad?" overridedLabel="Em que categoria devo me enquadrar/registrar para ser um afiliado MEI na Admitad?" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#em-que-categoria-devo-me-enquadrar-egistrar%20para-ser-um-afiliado-mei-na-admitad" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
- :Link[Passo a passo para se inscrever no MEI]{label="Passo a passo para se inscrever no MEI" overridedLabel="Passo a passo para se inscrever no MEI" spaceId docId="i05NdoWwto0MT9Hrd2Lvy" version="v2" docAnchorId="#passo-a-passo-para-se-inscrever-no-mei" loadingMethod="dynamic" newTab="false" href="guia-pessoa-fisica-pessoa-juridica-e-mei.mdx"}
